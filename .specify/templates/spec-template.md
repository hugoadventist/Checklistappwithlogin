...
- **FR-002**: System MUST [specific capability, e.g., "allow users to create accounts"]
- **FR-003**: System MUST [specific capability, e.g., "validate email addresses"]  
...
- **FR-006**: System MUST [behavior, e.g., "log all security events"]
